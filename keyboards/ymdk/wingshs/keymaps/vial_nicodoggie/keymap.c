...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
    ...
    KC_LGUI,   KC_LALT,        LT(1, KC_SPC),  LT(2, KC_ENT),              KC_BACKSPACE,           KC_APPLICATION,       KC_MPRV, KC_VOLD, KC_MNXT
  ),

  [1] = LAYOUT_all(
    KC_ESC,  KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,      KC_F7,   KC_F8,   KC_F9,  KC_F10,   KC_F11,  KC_F12,  _______,        _______,
    _______, KC_PGUP, KC_UP,   KC_PGDN,  KC_HOME, KC_INS, _______,     _______, _______, _______, _______, _______, _______, KC_DEL,           _______,
    _______, KC_LEFT, KC_DOWN, KC_RGHT,  KC_END,  KC_DEL, _______,     _______, _______, _______, _______, _______, _______,                   _______,
    _______, KC_CUT,  KC_COPY, KC_PASTE, KC_FIND, _______, _______,    _______, _______, _______, _______, _______,          _______,
...
const rgblight_segment_t PROGMEM rgblight_capslock[] = RGBLIGHT_LAYER_SEGMENTS({0, 15, HSV_RED});
const rgblight_segment_t PROGMEM rgblight_layer0[]   = RGBLIGHT_LAYER_SEGMENTS({0, 15, HSV_CUST_SKYBLUE}, {59, 1, HSV_CUST_PINK}, {60, 1, HSV_CUST_MINT});
const rgblight_segment_t PROGMEM rgblight_layer1[] = RGBLIGHT_LAYER_SEGMENTS({0, 15, HSV_CUST_PINK});
const rgblight_segment_t PROGMEM rgblight_layer2[] = RGBLIGHT_LAYER_SEGMENTS({0, 15, HSV_CUST_MINT}, {62, 1, HSV_CUST_LAVENDER});
const rgblight_segment_t PROGMEM rgblight_layer3[] = RGBLIGHT_LAYER_SEGMENTS({0, 15, HSV_CUST_LAVENDER}, {62, 1, HSV_CUST_SKYBLUE});

const rgblight_segment_t* const PROGMEM wings_rgblight_layers[] = RGBLIGHT_LAYERS_LIST(
    rgblight_layer0,
    rgblight_layer1,
    rgblight_layer2,
    rgblight_layer3
